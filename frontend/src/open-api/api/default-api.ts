...
export const DefaultApiAxiosParamCreator = function (
  ...
  return {
     ...
     * @throws {RequiredError}
     */
    addScheduletoEquipment: async (
      id: string,
      scheduleDTO: ScheduleDTO,
      options: any = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'id' is not null or undefined
      assertParamExists('addScheduletoEquipment', 'id', id);
      // verify required parameter 'scheduleDTO' is not null or undefined
      assertParamExists('addScheduletoEquipment', 'scheduleDTO', scheduleDTO);
      const localVarPath = `/api/v1/equipment/schedule/{id}`.replace(
        `{${'id'}}`,
     ...
     * @throws {RequiredError}
     */
    createNewOrganizer: async (
      organizerDTO: OrganizerDTO,
      options: any = {}
    ): Promise<RequestArgs> => {
      // verify required parameter 'organizerDTO' is not null or undefined
      assertParamExists('createNewOrganizer', 'organizerDTO', organizerDTO);
    ...
    deleteOrganizer: async (
      ...
      const localVarPath = `/api/v1/organizer/{id}`.replace(
        `{${'id'}}`,
        encodeURIComponent(String(id))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
    ...
    editUser: async (
      ...
      assertParamExists('editUser', 'userDTO', userDTO);
      const localVarPath = `/api/v1/user/{id}`.replace(
        `{${'id'}}`,
        encodeURIComponent(String(id))
      );
    ...
    updateOrganizer: async (
      ...
      // verify required parameter 'id' is not null or undefined
      assertParamExists('updateOrganizer', 'id', id);
      // verify required parameter 'organizerDTO' is not null or undefined
      assertParamExists('updateOrganizer', 'organizerDTO', organizerDTO);
      const localVarPath = `/api/v1/organizer/{id}`.replace(
        `{${'id'}}`,
        encodeURIComponent(String(id))
      );
...
export const DefaultApiFp = function (configuration?: Configuration) {
  ...
  return {
    ...
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.addEquipment(
        equipmentDTO,
        options
      );
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.addScheduletoEquipment(
          id,
          scheduleDTO,
          options
        );
     ...
     * @throws {RequiredError}
     */
    async createNewOrganizer(
      organizerDTO: OrganizerDTO,
      options?: any
    ): Promise<
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<OrganizerDTO>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.createNewOrganizer(
          organizerDTO,
          options
        );
      return createRequestFunction(
    ...
    async deleteOrganizer(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<OrganizerDTO>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.deleteOrganizer(
        id,
        options
      );
      return createRequestFunction(
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getAllEquipments(options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    async getAllOrganizers(
      ...
      (
        axios?: AxiosInstance,
        basePath?: string
      ) => AxiosPromise<Array<OrganizerDTO>>
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.getAllOrganizers(options);
      return createRequestFunction(
        localVarAxiosArgs,
        globalAxios,
        BASE_PATH,
    ...
    async updateOrganizer(
      ...
      (axios?: AxiosInstance, basePath?: string) => AxiosPromise<OrganizerDTO>
    > {
      const localVarAxiosArgs = await localVarAxiosParamCreator.updateOrganizer(
        id,
        organizerDTO,
        options
      );
...
export const DefaultApiFactory = function (
  ...
  return {
    ...
    addEquipment(
      equipmentDTO: EquipmentDTO,
      options?: any
    ): AxiosPromise<EquipmentDTO> {
      return localVarFp
        .addEquipment(equipmentDTO, options)
     ...
     * @throws {RequiredError}
     */
    addScheduletoEquipment(
      id: string,
      scheduleDTO: ScheduleDTO,
      options?: any
    ): AxiosPromise<EquipmentDTO> {
      return localVarFp
        .addScheduletoEquipment(id, scheduleDTO, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
    ...
    createNewOrganizer(
      ...
      return localVarFp
        .createNewOrganizer(organizerDTO, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    deleteOrganizer(id: string, options?: any): AxiosPromise<OrganizerDTO> {
      return localVarFp
        .deleteOrganizer(id, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
     ...
     * @throws {RequiredError}
     */
    getOrganizerByID(id: string, options?: any): AxiosPromise<OrganizerDTO> {
      return localVarFp
    ...
    updateEquipment(
      ...
      return localVarFp
        .updateEquipment(id, equipmentDTO, options)
        .then((request) => request(axios, basePath));
    },
    /**
     *
...
export class DefaultApi extends BaseAPI {
   ...
   * @memberof DefaultApi
   */
  public createNewOrganizer(organizerDTO: OrganizerDTO, options?: any) {
    return DefaultApiFp(this.configuration)
      .createNewOrganizer(organizerDTO, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof DefaultApi
   */
  public deleteOrganizer(id: string, options?: any) {
    return DefaultApiFp(this.configuration)
      .deleteOrganizer(id, options)
      .then((request) => request(this.axios, this.basePath));
  }
   ...
   * @memberof DefaultApi
   */
  public getAllEquipments(options?: any) {
    return DefaultApiFp(this.configuration)
      .getAllEquipments(options)
      .then((request) => request(this.axios, this.basePath));
  }
